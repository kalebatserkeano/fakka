...
<div><?php $html = ""; $url = "https://www.soccerstats247.com/RankingsRssWidget.aspx?langId=6&leagueId=1322&groupName=regular-season";$xml = simplexml_load_file($url); foreach($xml->channel->item as $item){$html .= $item->description;$html .= "<hr />";}echo $html; ?></div>
</body>
</html>